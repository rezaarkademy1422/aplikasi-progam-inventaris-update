...
<tr>
	<td><input type="date" name="tglpengembalian" value="<?php echo $data['tglpengembalian'];?>" style="width: 120px;"></td>
		<td><button type="submit" name="btn-edtTSHP" onclick="return confirm('Apakah Anda Yakin Akan Mengedit Data Tersebut ?')">Edit</button>
		<button><a href="transaksiHP.php">Kembali</a></button></td>
</tr>
