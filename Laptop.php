...
<tr>
	<td style="text-align: left; border:transparent;">
		...
		<button type="submit" name="btn-delLPT" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Tersebut ?')">Hapus</button><button><a name="btn-edtLPT" href="editLaptop.php?kodebarang=<?php echo $data['kodebarang']?>">Edit</a></button></td>
</tr>
