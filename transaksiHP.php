...
<tr>
	...
	<td style="text-align: left; border:transparent;"><button type="submit" name="btn-delTSHP"onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Tersebut ?')">Hapus</button><button><a name="btn-edtTSLPT" href="editTSHP.php?kodebarang=<?php echo $data['kodebarang']?>">Edit</a></button></td></td>
</tr>
