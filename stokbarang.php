...
<tr>
	...
	<td style="text-align: left; border:transparent;">
		...
		<button type="submit" name="btn-delstok" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Tersebut ?')">Hapus</button><button><a name="btn-edtSTK" href="editStkbarang.php?kodebarang=<?php echo $data['kodebarang']?>">Edit</a></button></td>
</tr>
