...
<tr>
	...
	<td style="text-align: left; border:transparent;"><button type="submit" name="btn-delKR" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data Tersebut ?')">Hapus</button><button><a name="btn-edtKR" href="editKaryawan.php?nik=<?php echo $data['nik']?>">Edit</a></button></td>
</tr>
